...
public class MenuController {
    public static void main(String[] args) {
        ...
        System.out.println("=================================================");
        System.out.println("Guest One ordered: " + guestOne.getNumServings() + " serving(s) of " + guestOne.getName() + ".");
        System.out.println("This is an " + guestOne.getCulturalOrigin() + " " + guestOne.getFoodCategory()
        ...
        System.out.println("=================================================");
        System.out.println("Guest Two ordered: " + guestTwo.getNumServings() + " serving(s) of " + guestTwo.getName() + ".");
        System.out.println("This is an " + guestTwo.getCulturalOrigin() + " " + guestTwo.getFoodCategory()
        ...
        System.out.println("=================================================");
        System.out.println("Guest Three ordered: " + guestThree.getNumServings() + " serving(s) of " + guestThree.getName() + ".");
        System.out.println("This is an " + guestThree.getCulturalOrigin() + " " + guestThree.getFoodCategory()
